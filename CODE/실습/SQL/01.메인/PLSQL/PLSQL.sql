...
BEGIN
     -- 실행부
     IF num1 > num2 THEN
        DBMS_OUTPUT.PUT_LINE('num1이 더 큽니다.');
     ELSIF num1 < num2 THEN
        DBMS_OUTPUT.PUT_LINE('num2가 더 큽니다.');
     ELSE
        DBMS_OUTPUT.PUT_LINE('값이 갑습니다.');
     END IF;
END;
/
...
DECLARE
       -- 테이블명.컬럼%TYPE : 컬럼의 데이터 타입을 참조하여 지정
...
-- 109. LOOP문을 이용하여 구구단을 출력하는 PL/SQL블록을 작성하시오.
...
-- 110. WHILE LOOP문을 이용하여 구구단을 출력하는 PL/SQL블록을 작성하시오.
...
-- 111. FOR LOOP문을 이용하여 구구단을 출력하는 PL/SQL블록을 작성하시오.
...
/*
   112 
   반복문을 활용하여 
   1~20사이의 정수 중 홀수만 출력하는 PL/SQL문을 작성하시오.
*/
...
/*
   113.
   테이블 employee와 dapqrtment를 조인하여
   사원명과 부서명을 각각 vs_emp_name, vs_dept_name변수에 대입하고
   출력하는 PL/SQL블록을 작성하시오.
*/
...
-- 114. 사원번호로 부서명을 구하는 함수를 정의하는 PL/SQL을 작성하시오.
